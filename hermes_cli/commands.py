...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("plan", "Enter Plan Mode — read-only investigation and structured plan artifact",
    ...
    CommandDef("hooks", "List user-defined lifecycle hooks loaded for this session",
               "Configuration", args_hint="[reload|trust]", cli_only=True),
    CommandDef("verify", "Manually trigger a self-verification pass on the last response",
               "Session", cli_only=True),
    ...
    CommandDef("audit", "Inspect the structured audit log of hook/verifier/plan events",
               "Info", args_hint="[tail [N]|summary|path|verify]", cli_only=True),
    ...
    CommandDef("promotions", "Review auto-promotion candidates derived from lesson clusters",
               "Info", args_hint="[list|install <name>|install-all]", cli_only=True),
